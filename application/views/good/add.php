    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Good Add</h3>
            </div>
            <?php echo form_open('good/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="GoodName" class="control-label"><span class="text-danger">*</span>GoodName</label>
						<div class="form-group">
							<input type="text" name="GoodName" value="<?php echo $this->input->post('GoodName'); ?>" class="form-control" id="GoodName" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="Pic" value="<?php echo $this->input->post('Pic'); ?>" class="form-control" id="Pic" />
