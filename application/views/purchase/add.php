          	...
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="CardID" class="form-control">
								...
								{
									$selected = ($card['CardID'] == $this->input->post('CardID')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="StoreID" class="form-control">
								...
								{
									$selected = ($store['StoreID'] == $this->input->post('StoreID')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="GST" value="<?php echo $this->input->post('GST'); ?>" class="form-control" id="GST" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="PST" value="<?php echo $this->input->post('PST'); ?>" class="form-control" id="PST" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="Memo" value="<?php echo $this->input->post('Memo'); ?>" class="form-control" id="Memo" />
