    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Card Edit</h3>
            </div>
			<?php echo form_open('card/edit/'.$card['CardID']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="UserID" class="form-control">
								...
								{
									$selected = ($user['UserID'] == $card['UserID']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="BankID" class="form-control">
								...
								{
									$selected = ($bank['BankID'] == $card['BankID']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="CardTypeID" class="form-control">
								...
								{
									$selected = ($card_type['CardTypeID'] == $card['CardTypeID']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="ExpMonth" class="form-control">
								...
								{
									$selected = ($value == $card['ExpMonth']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="ExpYear" class="form-control">
								...
								{
									$selected = ($value == $card['ExpYear']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="CardNum" value="<?php echo ($this->input->post('CardNum') ? $this->input->post('CardNum') : $card['CardNum']); ?>" class="form-control" id="CardNum" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="SecureNum" value="<?php echo ($this->input->post('SecureNum') ? $this->input->post('SecureNum') : $card['SecureNum']); ?>" class="form-control" id="SecureNum" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="Balance" value="<?php echo ($this->input->post('Balance') ? $this->input->post('Balance') : $card['Balance']); ?>" class="form-control" id="Balance" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="Limit" value="<?php echo ($this->input->post('Limit') ? $this->input->post('Limit') : $card['Limit']); ?>" class="form-control" id="Limit" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="Order" value="<?php echo ($this->input->post('Order') ? $this->input->post('Order') : $card['Order']); ?>" class="form-control" id="Order" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="Description" class="form-control" id="Description"><?php echo ($this->input->post('Description') ? $this->input->post('Description') : $card['Description']); ?></textarea>
